...
export function EventModal({ event, spellTemplates, onResolved }: Props) {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-box parchment-card">
        {stage === "choosing" && (
          <>
            ...
            <div className="choice-list">
              {event.choices.map((choice) => (
                ...
                >
                  {choice.text}
                  {choice.requiresSpell && <span className="pill" style={{ marginLeft: 8 }}>заклинание</span>}
                </button>
              ))}
            </div>
          </>
